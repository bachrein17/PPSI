...
<div class="jumbotron jumbotron-fluid">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="display-4" style="font-family: 'Poppins'; font-size: 30px; font-weight : bold; color:yellow">Temukan & Dukung<br>Produk Lokal Terbaik!</h1>
                <p class="lead" style="font-family : 'Poppins'; width:90%;">Sumber UMKM adalah platform yang mempertemukan masyarakat dengan produk lokal unggulan dari pelaku UMKM. Mulai dari makanan, kerajinan, hingga fashion, kami hadir untuk memudahkan pencarian dan dukungan terhadap usaha kecil di sekitar Anda. Temukan produk asli Indonesia dan jadilah bagian dari pemberdayaan ekonomi lokal!</p>
        ...
        <div class="col">
            <div class="card h-100 text-center border-0">
                <div class="card-body">
                    ...
                    <p class="Deskripsi">Temukan beragam makanan khas lokal dengan cita rasa otentik dan bahan-bahan berkualitas dari UMKM pilihan.</p>
        ...
        <div class="col">
            <div class="card h-100 text-center border-0">
                <div class="card-body">
                    ...
                    <p class="Deskripsi">Dari minuman herbal hingga kopi lokal, pilih minuman yang mendukung kesehatan Anda.</p>
        ...
        <div class="col">
            <div class="card h-100 text-center border-0">
                <div class="card-body">
                    ...
                    <p class="Deskripsi">Kenakan pakaian dan aksesori dari perajin lokal yang mencerminkan budaya Indonesia.</p>
        ...
        <div class="col">
            <div class="card h-100 text-center border-0">
                <div class="card-body">
                    ...
                    <p class="Deskripsi">Produk kerajinan unik, dari dekorasi hingga cenderamata, dibuat dengan keterampilan lokal.</p>
...
<!-- Promotion Section -->
<div class="container promotion-section my-5" style="background-color: #4BAA38; padding: 20px; border-radius: 25px;">
...
<div class="container cta-section my-5">
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            ...
            <p>Sumber UMKM menyediakan platform digital untuk memudahkan pelaku usaha kecil dalam mempromosikan produk mereka.</p>
